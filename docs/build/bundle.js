...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block1 = /*stickToTop*/ ctx[0] && create_if_block(ctx);
    ...
    // (719:12) {#each availableQuoteAssets as asset}
    function create_each_block_2(ctx) {
    	let button;
    	let t0_value = /*asset*/ ctx[29] + "";
    	let t0;
    	let t1;
    	...
    	function click_handler_1() {
    		return /*click_handler_1*/ ctx[15](/*asset*/ ctx[29]);
    	}

    	function mouseenter_handler_1() {
    		return /*mouseenter_handler_1*/ ctx[16](/*asset*/ ctx[29]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			button.value = button_value_value = /*asset*/ ctx[29];
    			set_style(button, "background-color", quoteBackgroundColor(/*selectedAssets*/ ctx[1], /*relatedQuoteAssets*/ ctx[4], /*asset*/ ctx[29]));
    			add_location(button, file, 719, 14, 17181);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*availableQuoteAssets*/ 4 && t0_value !== (t0_value = /*asset*/ ctx[29] + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*availableQuoteAssets*/ 4 && button_value_value !== (button_value_value = /*asset*/ ctx[29])) {
    				prop_dev(button, "value", button_value_value);
    			}

    			if (dirty[0] & /*selectedAssets, relatedQuoteAssets, availableQuoteAssets*/ 22) {
    				set_style(button, "background-color", quoteBackgroundColor(/*selectedAssets*/ ctx[1], /*relatedQuoteAssets*/ ctx[4], /*asset*/ ctx[29]));
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(719:12) {#each availableQuoteAssets as asset}",
    		ctx
    	});
    ...
    function create_content_slot(ctx) {
    	...
    	let t1;
    	let div1;
    	let each_value_2 = /*availableQuoteAssets*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 716, 10, 17023);
    			attr_dev(div1, "class", "flex flex-wrap justify-center");
    			add_location(div1, file, 717, 10, 17073);
    			attr_dev(div2, "slot", "content");
    			add_location(div2, file, 715, 8, 16992);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*availableQuoteAssets, selectedAssets, relatedQuoteAssets, toggleAsset, showRelatedQuoteAssets, resetRelatedQuoteAssets*/ 1814) {
    				each_value_2 = /*availableQuoteAssets*/ ctx[2];
    				validate_each_argument(each_value_2);
    				let i;
    ...
    // (736:12) {#each availableBaseAssets as asset}
    function create_each_block_1(ctx) {
    	...
    	function click_handler() {
    		return /*click_handler*/ ctx[13](/*asset*/ ctx[29]);
    	}

    	function mouseenter_handler() {
    		return /*mouseenter_handler*/ ctx[14](/*asset*/ ctx[29]);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(button, "background-color", /*selectedAssets*/ ctx[1].includes(/*asset*/ ctx[29])
    			? '#c8c8c8'
    			: '#fff');

    			add_location(button, file, 736, 14, 17899);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t0);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*availableBaseAssets*/ 8 && t0_value !== (t0_value = /*asset*/ ctx[29] + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*availableBaseAssets*/ 8 && button_value_value !== (button_value_value = /*asset*/ ctx[29])) {
    				prop_dev(button, "value", button_value_value);
    			}

    			if (dirty[0] & /*selectedAssets, availableBaseAssets*/ 10) {
    				set_style(button, "background-color", /*selectedAssets*/ ctx[1].includes(/*asset*/ ctx[29])
    				? '#c8c8c8'
    				: '#fff');
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(736:12) {#each availableBaseAssets as asset}",
    		ctx
    	});
    ...
    function create_wrapper_slot(ctx) {
    	...
    	let t2;
    	let div2;
    	let each_value_1 = /*availableBaseAssets*/ ctx[3];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 732, 10, 17709);
    			attr_dev(div1, "class", "text-xl");
    			add_location(div1, file, 733, 10, 17743);
    			attr_dev(div2, "class", "flex flex-wrap justify-center");
    			add_location(div2, file, 734, 10, 17792);
    			attr_dev(div3, "slot", "wrapper");
    			attr_dev(div3, "class", "p-4");
    			add_location(div3, file, 731, 8, 17666);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*availableBaseAssets, selectedAssets, toggleAsset, showRelatedQuoteAssets, resetRelatedQuoteAssets*/ 1802) {
    				each_value_1 = /*availableBaseAssets*/ ctx[3];
    				validate_each_argument(each_value_1);
    				let i;
    ...
    // (759:8) {#each paths as path (path.joined)}
    function create_each_block(key_1, ctx) {
    	let div1;
    	let span0;
    	let t0_value = /*path*/ ctx[26].percent + "";
    	let t0;
    	let t1;
    	let t2;
    	let div0;
    	let t3;
    	let span1;
    	let t4_value = /*path*/ ctx[26].joined + "";
    	let t4;
    	let t5;
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			set_style(span0, "color", /*path*/ ctx[26].isProfitable ? 'green' : 'red');
    			add_location(span0, file, 760, 12, 18697);
    			attr_dev(div0, "class", "w-1");
    			add_location(div0, file, 764, 12, 18888);
    			attr_dev(span1, "class", "w-40");
    			add_location(span1, file, 765, 12, 18924);
    			attr_dev(div1, "class", "flex");
    			add_location(div1, file, 759, 10, 18666);
    			this.first = div1;
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*paths*/ 32 && t0_value !== (t0_value = /*path*/ ctx[26].percent + "")) set_data_dev(t0, t0_value);

    			if (dirty[0] & /*paths*/ 32) {
    				set_style(span0, "color", /*path*/ ctx[26].isProfitable ? 'green' : 'red');
    			}

    			if (dirty[0] & /*paths*/ 32 && t4_value !== (t4_value = /*path*/ ctx[26].joined + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(759:8) {#each paths as path (path.joined)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const get_key = ctx => /*path*/ ctx[26].joined;
    	...
    	const block = {
    		c: function create() {
    			...
    			t9 = space();
    			p = element("p");
    			p.textContent = "This app monitors arbitrage opportunities on Binance. It is a web app that uses the Binance API to fetch the\n      current price of the assets and then calculates the arbitrage opportunities. The arbitrage opportunities are then\n      displayed in a table.";
    			t11 = space();
    			div5 = element("div");
    			t12 = space();
    			div9 = element("div");
    			...
    			attr_dev(div0, "class", "h-4");
    			add_location(div0, file, 659, 0, 15102);
    			...
    			add_location(img, file, 664, 6, 15239);
    			attr_dev(div1, "class", "w-full h-full flex justify-center items-center");
    			add_location(div1, file, 663, 4, 15172);
    			attr_dev(div2, "class", "w-1/3");
    			add_location(div2, file, 662, 2, 15148);
    			attr_dev(div3, "class", "w-4");
    			add_location(div3, file, 668, 2, 15448);
    			attr_dev(span0, "id", "websocket-status");
    			set_style(span0, "color", /*wsStatus*/ ctx[6]);
    			add_location(span0, file, 671, 14, 15548);
    			attr_dev(h1, "class", "text-2xl");
    			add_location(h1, file, 670, 4, 15512);
    			attr_dev(h2, "class", "test-xl");
    			add_location(h2, file, 673, 4, 15654);
    			attr_dev(div4, "class", "h-4");
    			add_location(div4, file, 676, 4, 15741);
    			attr_dev(p, "class", "w-[50vw]");
    			add_location(p, file, 677, 4, 15769);
    			attr_dev(div5, "class", "h-4");
    			add_location(div5, file, 683, 4, 16067);
    			attr_dev(a0, "class", "font-bold");
    			attr_dev(a0, "href", "#");
    			add_location(a0, file, 689, 16, 16256);
    			add_location(li0, file, 689, 12, 16252);
    			attr_dev(a1, "href", "#");
    			add_location(a1, file, 690, 16, 16322);
    			add_location(li1, file, 690, 12, 16318);
    			attr_dev(a2, "href", "#");
    			add_location(a2, file, 691, 16, 16367);
    			add_location(li2, file, 691, 12, 16363);
    			attr_dev(ul, "class", "flex gap-4");
    			add_location(ul, file, 688, 10, 16216);
    			add_location(nav, file, 687, 8, 16200);
    			add_location(span1, file, 696, 10, 16508);
    			attr_dev(div6, "class", "w-4");
    			add_location(div6, file, 697, 10, 16536);
    			attr_dev(input, "type", "number");
    			attr_dev(input, "class", "p-1");
    			add_location(input, file, 698, 10, 16570);
    			attr_dev(div7, "class", "w-4");
    			add_location(div7, file, 699, 10, 16669);
    			attr_dev(span2, "class", "font-mono");
    			add_location(span2, file, 700, 10, 16703);
    			attr_dev(form, "id", "fees");
    			attr_dev(form, "class", "flex items-center justify-center");
    			add_location(form, file, 695, 8, 16440);
    			attr_dev(div8, "class", "flex items-center justify-between");
    			add_location(div8, file, 686, 6, 16144);
    			attr_dev(div9, "class", "p-4 shadow rounded bg-white");
    			add_location(div9, file, 685, 4, 16096);
    			attr_dev(div10, "class", "flex flex-col w-2/3");
    			add_location(div10, file, 669, 2, 15474);
    			attr_dev(div11, "class", "flex");
    			add_location(div11, file, 661, 0, 15127);
    			attr_dev(div12, "class", "h-4");
    			add_location(div12, file, 707, 0, 16826);
    			attr_dev(div13, "id", "asset-buttons");
    			attr_dev(div13, "class", "shadow rounded bg-white");
    			add_location(div13, file, 712, 4, 16904);
    			attr_dev(div14, "class", "w-1/3");
    			add_location(div14, file, 710, 2, 16879);
    			attr_dev(div15, "class", "w-4");
    			add_location(div15, file, 752, 2, 18410);
    			attr_dev(div16, "class", "text-xl flex justify-center");
    			add_location(div16, file, 756, 6, 18509);
    			attr_dev(div17, "class", "flex flex-wrap justify-center");
    			add_location(div17, file, 757, 6, 18568);
    			attr_dev(div18, "class", "p-4 shadow rounded bg-white");
    			add_location(div18, file, 755, 4, 18461);
    			attr_dev(div19, "class", "w-2/3");
    			add_location(div19, file, 754, 2, 18437);
    			attr_dev(div20, "class", "w-full flex");
    			add_location(div20, file, 709, 0, 16851);
    			attr_dev(div21, "class", "h-4");
    			add_location(div21, file, 773, 0, 19038);
    			add_location(footer, file, 775, 0, 19063);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(stickycontent, div13, null);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*availableBaseAssets, selectedAssets, availableQuoteAssets, relatedQuoteAssets*/ 30 | dirty[1] & /*$$scope*/ 8) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		getPairings().then(remotePairings => {
    			...
    			$$invalidate(2, availableQuoteAssets = Object.keys(remotePairings));
    			$$invalidate(3, availableBaseAssets = [...new Set(Object.values(remotePairings).flat(1))].filter(base => !Object.keys(remotePairings).includes(base)));
    		});
    	...
    	function addPercent(possiblePaths = paths) {
    		$$invalidate(5, paths = possiblePaths.map(addPercentChange(prices, feePerTrade)).filter(Boolean));
    	}

    	function fillPaths() {
    		const possiblePaths = generatePaths(selectedAssets).map(addPairs(pairings)).filter(path => path.pairs.every(Boolean));
    	...
    	function toggleAsset(asset) {
    		if (selectedAssets.includes(asset)) {
    			$$invalidate(1, selectedAssets = selectedAssets.filter(c => c !== asset));
    		} else {
    			$$invalidate(1, selectedAssets = [...selectedAssets, asset]);
    		}
    	...
    	function showRelatedQuoteAssets(asset) {
    		$$invalidate(4, relatedQuoteAssets = Object.keys(pairings).filter(c => pairings[c].includes(asset)));
    	}

    	function resetRelatedQuoteAssets() {
    		$$invalidate(4, relatedQuoteAssets = []);
    	}
    	...
    	const keyup_handler = () => addPercent();
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('availableQuoteAssets' in $$props) $$invalidate(2, availableQuoteAssets = $$props.availableQuoteAssets);
    		if ('availableBaseAssets' in $$props) $$invalidate(3, availableBaseAssets = $$props.availableBaseAssets);
    		if ('relatedQuoteAssets' in $$props) $$invalidate(4, relatedQuoteAssets = $$props.relatedQuoteAssets);
